          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ExpansionTile(
                  leading: Icon(faq['icon'] as IconData, color: Colors.deepPurpleAccent),
                  title: Text(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              DropdownMenuItem(
                                value: 'Masculino',
                                child: Text('Masculino', style: TextStyle(color: Colors.black, fontSize: 17)),
                              ),
                              DropdownMenuItem(
                                value: 'Femenino',
                                child: Text('Femenino', style: TextStyle(color: Colors.black, fontSize: 17)),
                              ),
                              DropdownMenuItem(
                                value: 'No binario',
                                child: Text('No binario', style: TextStyle(color: Colors.black, fontSize: 17)),
                              ),
                              DropdownMenuItem(
                                value: 'No especificado',
                                child: Text('No especificado', style: TextStyle(color: Colors.black, fontSize: 17)),
                              ),
                            ],
                            selectedItemBuilder: (context) => [
                              const Text('Masculino', style: TextStyle(color: Colors.white70, fontSize: 17)),
                              const Text('Femenino', style: TextStyle(color: Colors.white70, fontSize: 17)),
                              const Text('No binario', style: TextStyle(color: Colors.white70, fontSize: 17)),
                              const Text('No especificado', style: TextStyle(color: Colors.white70, fontSize: 17)),
                            ],
                            onChanged: (value) {
                              if (value != null) {
                                setState(() {
